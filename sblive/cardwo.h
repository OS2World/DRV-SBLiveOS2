/* $Id: cardwo.h,v 1.1 2000/04/23 14:55:43 ktk Exp $ */
...
struct wave_xferbuf 
{
	u32     xferpos;	/* where to write() next */
	u32     silence_xferpos; /* where to xx_fillsilence() next */
...
struct woinst 
{
	...
	u32 silence_bytes;	/* total number of bytes xx_fillsilence() to the buffer */
        u32 blocks;
	u32 curpos;		/* hardware cursor position */
	u32 device;
	spinlock_t lock;
};
