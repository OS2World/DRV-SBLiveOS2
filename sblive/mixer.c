/* $Id: mixer.c,v 1.5 2001/10/08 11:26:46 sandervl Exp $ */
...
{
	AC97_MASTERVOLUME, 	//SOUND_MIXER_VOLUME
	AC97_GENERALPUPOSE, 	//SOUND_MIXER_BASS
	AC97_MASTERTONE,   	//SOUND_MIXER_TREBLE
        0, 			//SOUND_MIXER_SYNTH
	AC97_PCMOUTVOLUME,	//SOUND_MIXER_PCM
	AC97_PCBEEPVOLUME,	//SOUND_MIXER_SPEAKER
	AC97_LINEINVOLUME,	//SOUND_MIXER_LINE
	AC97_MICVOLUME,		//SOUND_MIXER_MIC
	AC97_CDVOLUME,		//SOUND_MIXER_CD
	0, 			//SOUND_MIXER_IMIX
	0, 			//SOUND_MIXER_ALTPCM
	AC97_RECORDGAIN,	//SOUND_MIXER_RECLEV
	AC97_RECORDGAIN,	//SOUND_MIXER_IGAIN
	AC97_MASTERVOLUMEMONO,	//SOUND_MIXER_OGAIN
	AC97_AUXVOLUME,		//SOUND_MIXER_LINE1
	AC97_PCMOUTVOLUME,	//SOUND_MIXER_LINE2
	0,			//SOUND_MIXER_LINE3
	0,			//SOUND_MIXER_DIGITAL1
	AC97_MASTERVOLUME,	//SOUND_MIXER_DIGITAL2
	0,			//SOUND_MIXER_DIGITAL3
	AC97_PHONEVOLUME,	//SOUND_MIXER_PHONEIN
	AC97_HEADPHONEVOLUME,	//SOUND_MIXER_PHONEOUT
	AC97_VIDEOVOLUME,	//SOUND_MIXER_VIDEO
	0, 			//SOUND_MIXER_RADIO
	0, 			//SOUND_MIXER_MONITOR
};
#else
static const unsigned char volreg[SOUND_MIXER_NRDEVICES] = {
	/* 5 bit stereo */
...
{
	6, 			//SOUND_MIXER_VOLUME
	15, 			//SOUND_MIXER_BASS
	14,   			//SOUND_MIXER_TREBLE
        0, 			//SOUND_MIXER_SYNTH
	5,			//SOUND_MIXER_PCM
	10,			//SOUND_MIXER_SPEAKER
	1,			//SOUND_MIXER_LINE
	11,			//SOUND_MIXER_MIC
	2,			//SOUND_MIXER_CD
	0, 			//SOUND_MIXER_IMIX
	16, 			//SOUND_MIXER_ALTPCM
	12,			//SOUND_MIXER_RECLEV
	13,			//SOUND_MIXER_IGAIN
	8,			//SOUND_MIXER_OGAIN
	4,			//SOUND_MIXER_LINE1
	16,			//SOUND_MIXER_LINE2
	17,			//SOUND_MIXER_LINE3
	18,			//SOUND_MIXER_DIGITAL1
	19,			//SOUND_MIXER_DIGITAL2
	0,			//SOUND_MIXER_DIGITAL3
	9,			//SOUND_MIXER_PHONEIN
	7, 			//SOUND_MIXER_PHONEOUT
	3,			//SOUND_MIXER_VIDEO
	0, 			//SOUND_MIXER_RADIO
	0, 			//SOUND_MIXER_MONITOR
};
...
#if 1
static  unsigned char LinToLog[100] = {  
...
static  unsigned char LinToLog[100] = {  
 ...
 10,  10,  16,  19,  20,  22,  24,  25,  27,  27, 
 28,  28,  29,  30,  30,  35,  35,  35,  39,  39,  
 43,  45,  47,  49,  50,  50,  60,  60,  70,  72,  
 72,  74,  74,  74,  75,  75,  76,  77,  78,  80,  
 82,  83,  85,  85,  85,  88,  88,  88,  88,  90,
 90,  93,  93,  93,  95,  95,  95,  95,  95,  95,  
...
static int update_pcm_attn(struct emu10k1_card *card, unsigned l1, unsigned r1)
{
	...
	//SvL; First call (during mixer init) must return 0 and fill in the
        //     arrwVol array. Only then will update_digital be called.
        //     If this doesn't happen, sound is disabled.
        //     Check here that current->files != 0
	for (i = 0; i < MAX_PCM_CHANNELS; i++) {
#ifdef TARGET_OS2
		if (current->files && sblive_pcm_volume[i].files == current->files) {
#else
